                        ...
                        <div className="col-lg-6 col-md-12 order-2 order-lg-1">
                            <div className="contact-form-content pt-sm-55 pt-xs-55">
                                ...
                                <div className="contact-form">
                                    <form className="form_login_contact" action="http://demo.hasthemes.com/limupa-v3/limupa/mail.php" method="post">
                                        <div className = "form-inner">
                                        <h1 className="contact-page-title">Tell Us Your Message</h1>
                                        ...
                                        <div className="form-group">
                                            <label>Your Email <span className="required">*</span></label><br/>
