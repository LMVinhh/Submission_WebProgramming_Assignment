        ...
        <div id="introducei">
            <div className="introducei">
                ...
                >
                    ...
                    <div>
                       <p>Được thành lập từ năm 2022, SaiGon Sky với phương châm 
                        "Đồng hành cùng phong cách thời trang của bạn" sẽ là nơi mua sắm an toàn và uy tín, 
                        bởi chúng tôi luôn đề cao tiêu chí mang đến cho quý khách những sản phẩm chất lượng nhất với giá cả luôn phải chăng. 
                        Đa phong cách, đa thương hiệu, đa phân khúc – luôn có nhiều hơn một giải pháp tối ưu cho từng sự lựa chọn riêng biệt tại SaiGon Sky.                   </p>  </div>
                    ...
                    >
                        ...
                        <Link to='/about' className="button_about_us">
                            Xem thêm
                        </Link>
